...
class ServiceContract extends Page
{
    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.service-contract';

    protected static ?string $title = 'Contrato de Serviço';

    protected static ?string $navigationLabel = 'Contrato de Serviço';

    protected static ?string $navigationGroup = 'Termos';

    protected static ?string $slug = 'contrato-de-servico';

    protected static ?int $navigationSort = 1;

    public ?array $data = [];

    public ?ServiceContractModel $model;

    public function mount(): void
    {
        $this->model = ServiceContractModel::first();
    ...
    public function save(): void
    {
        ...
        $this->model = ServiceContractModel::create($data);
    ...
    public function getModel(): ?ServiceContractModel
    {
