...
class PartnershipAgreement extends Page
{
    protected static string $view = 'filament.pages.partnership-agreement';

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static ?string $title = 'Contrato de Parceria';

    protected static ?string $navigationLabel = 'Contrato de Parceria';

    protected static ?string $navigationGroup = 'Termos';

    protected static ?string $slug = 'contrato-de-parceria';

    protected static ?int $navigationSort = 1;

    public ?array $data = [];

    public ?PartnershipAgreementModel $model;

    public function mount(): void
    {
        $this->model = PartnershipAgreementModel::first();
    ...
    public function save(): void
    {
        ...
        $this->model = PartnershipAgreementModel::create($data);
    ...
    public function getModel(): ?PartnershipAgreementModel
    {
